...
CREATE INDEX IF NOT EXISTS "idx_public_status_hourly_rollups_group_model" ON "public_status_hourly_rollups" USING btree ("public_group_slug","public_model_key");--> statement-breakpoint
