...
usersRouter.openapi(
  createRoute({
    method: "post",
    path: "/users/{id}/quota:sync-keys",
    middleware: requireAuth("admin"),
    tags: ["Users"],
    summary: "Sync user quota to keys",
    description: "Copies user-level quota fields to the user's active keys.",
    "x-required-access": "admin",
    security,
    request: { params: UserIdParamSchema },
    responses: {
