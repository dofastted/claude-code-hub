...
} from "@/lib/keys/temporary-key-batches";
import { type PortalAccessScope, validatePortalRequest } from "@/lib/portal/auth";
import {
  serializePortalPlan,
  serializePortalProvisionResult,
  serializePortalSubscription,
} from "@/lib/portal/serialization";
import { PortalSubscriptionError, provisionPortalSubscription } from "@/lib/portal/subscriptions";
import { notifyFkWebPortalEvent } from "@/lib/portal/web-callback";
...
import { ensureDefaultUserGroupConfigs } from "@/repository/user-group-configs";
